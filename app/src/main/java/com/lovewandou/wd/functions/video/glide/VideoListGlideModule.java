package com.lovewandou.wd.functions.video.glide;
...
//        registry.prepend(GlideUrl.class, InputStream.class, new OkHttpUrlLoader.Factory(sClient));
    }
        ...
        private Source source(Source source) {
            return new ForwardingSource(source) {
                ...
                public long read(Buffer sink, long byteCount) throws IOException {
                    Log.e("read","byteCount:"+byteCount);
