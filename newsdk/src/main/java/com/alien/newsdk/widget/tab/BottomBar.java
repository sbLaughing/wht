...
//        addView(shadowView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    public BottomBar addCustom(){
        TextView textView = new TextView(getContext());
        textView.setText("");
//        textView.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_home_post,0,0);
        textView.setLayoutParams(mTabParams);
    ...
    public BottomBar addItem(final BottomBarTab tab) {
        ...
        int position = mTabLayout.getChildCount();
