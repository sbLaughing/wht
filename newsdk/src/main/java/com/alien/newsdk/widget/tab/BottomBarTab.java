package com.alien.newsdk.widget.tab;
...
//        mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tab_unselect));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            if (selectRes!=0){
                mIcon.setImageResource(selectRes);
            }else {
//                mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.colorPrimary));
            }
            if (mTvTitle!=null) mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.colorPrimary));
        } else {
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tab_unselect));
            mIcon.setImageResource(unselectRes);
            if (mTvTitle!=null) mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tab_unselect));
        }
    }
